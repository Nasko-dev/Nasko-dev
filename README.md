...
![skills](https://skillicons.dev/icons?i=html,css,js,ts,nodejs,react,next,vite,firebase,mongodb,git,figma,vscode,apple,github,gitlab,jest,kali,materialui,netlify,npm,postgres,redux,regex,styledcomponents,tailwind,threejs&theme=dark)
