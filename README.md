...
![skills]([https://skillicons.dev/icons?i=html,css,js,lua,react,figma,vscode,apple,github,threejs,discord&theme=dark](https://skillicons.dev/icons?i=html,css,tailwindcss,js,lua,react,nextjs,figma,vscode,apple,github,threejs,discord,nodejs,expressphp,mysql,mongodb,supabase,git,vite&theme=dark))
